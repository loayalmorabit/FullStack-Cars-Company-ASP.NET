<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Landing.aspx.cs" Inherits="Z.Landing" %>
    ...
    <section id="home" class="welcome-hero">
          ...
          >
            <div class="container">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="font-family: 'Lemonada', sans-serif;"
                  >الزعيم للسيارات<span></span
                ></a>
              </div>
              <!--/.navbar-header-->
              ...
              >
                ...
                >
                  ...
                  <li class="scroll">
                    <a href="#"><asp:Label ID="UsernameLabel" runat="server" style="color:white" /></a>
                  </li>
                  <li class="scroll">
                    <a href="#"><asp:Button ID="LogoutButton" runat="server" Text="Logout" OnClick="LogoutButton_Click" CssClass="btn-danger" /></a>
                  </li>
                </ul>
                <!--/.nav -->
              </div>
      ...
      <div class="container">
        <div class="welcome-hero-txt">
          <h2 style="font-family: 'Lemonada', sans-serif;">احصل على سيارتك الفارهة الان مع المرابط والمهايني ديلر شوب</h2>
          <p>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="single-footer-widget">
                <div class="footer-logo">
                  <a href="index.html" style="font-family: 'Lemonada', sans-serif;">الزعيم للسيارات</a>
                </div>
                <p>
